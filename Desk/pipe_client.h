...
#ifndef  _C_PIPE_CLIENT_H_
#define  _C_PIPE_CLIENT_H_
#include <windows.h>
#include <iostream>
#include <string> 
namespace chen {
...
public:
    ...
    std::string SendRequest(const std::string& request) {
        DWORD bytesWritten;
        if (!WriteFile(m_hPipe, request.c_str(), 
                       static_cast<DWORD>(request.length()), 
                       &bytesWritten, NULL)) {
