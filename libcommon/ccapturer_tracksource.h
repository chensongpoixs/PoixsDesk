...
//
//namespace chen {
//	//class DesktopCapture1;
//
//	class ProxyVideoTrackSource : public webrtc::VideoTrackSource {
//	public:
//		static webrtc::scoped_refptr<ProxyVideoTrackSource> Create()
//		{ 
//			std::unique_ptr< chen::DesktopCapture1> capturer(
//				chen::DesktopCapture1::Create(25, 0));
//			if (capturer) {
//				capturer->StartCapture();
//				return webrtc::make_ref_counted<ProxyVideoTrackSource>(std::move(capturer));
//			}
//			return nullptr;
//		}
//		 
...
//			std::unique_ptr< chen::DesktopCapture1> video_source)
...
//
//		std::unique_ptr< chen::DesktopCapture1> video_source_ptr;
//	};
//}
//
//
