...
function showConnectOverlay() {
    ...
    startText.innerHTML = 'Cloud Computer ';
...
// const age = getUrlParam('age');   // '30'

function HttpRequestPost(offerSdp)
{
    ...
    console.log('offer:',  offerSdp.sdp);
	// 创建要发送的数据对象
	var data = {
		type: 'offer',
		sdp: offerSdp.sdp,
...
function setupNormalizeAndQuantize() {
    ...
    {
        console.log('=========================================playerElement.clientHeight:' + playerElement.clientHeight+ ', playerElement.clientWidth:'+playerElement.clientWidth+' =====videoElement[0].videoHeight:'+videoElement[0].videoHeight+', videoElement[0].videoWidth:'+videoElement[0].videoWidth+'=====================================');
        let playerAspectRatio = playerElement.clientHeight / playerElement.clientWidth;
...
function emitMouseMove(x, y, deltaX, deltaY) {
    ...
    console.log(`coord.x: ${coord.x}, coord.y: ${coord.y}, delta:${delta}, dX: ${deltaX}, dY: ${deltaY}`);
